...
export class SearchModal {
    private readonly emptyResultTitle: Title;
    private readonly searchInput: Input;
    private readonly searchResult: ListItem;

    constructor(public page: Page) {
        this.emptyResultTitle = new Title({ page, locator: 'p.DocSearch-Help', name: 'Empty results' });
    ...
    async modalIsOpened(): Promise<void> {
        ...
        await this.emptyResultTitle.shouldBeVisible();
    }
